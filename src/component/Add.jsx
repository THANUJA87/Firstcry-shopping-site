  ...
  return (
   <>
    <div className='d-flex align-items-center'>
        <button onClick={handleShow}  className='btn btn-primary rounded-circle '>+</button>
    </div>
    <Modal
        show={show}
        onHide={handleClose}
      ...
      >
        ...
        <Modal.Body>
          <div className='border rounded p-3'>
            ...
            <Form.Control onChange={e =>setProductDetails({...productDetails,imageUrl:e.target.value}) }   type="text" placeholder=" Image URL" />
            </FloatingLabel>
        ...
        <Modal.Footer>
          ...
          <Button onClick={handleUploadProduct}  variant="primary" >Add</Button>
        </Modal.Footer>
      </Modal>
   </>
  )
